...
ActiveRecord::Schema.define(version: 20180418165435) do

  create_table "maryland_campaign_finance_candidates", force: :cascade do |t|
  ...
  create_table "maryland_campaign_finance_committees", force: :cascade do |t|
    ...
    t.string  "chair_full_address",        limit: 255
    t.string  "treasurer_full_address",    limit: 255
  end

  create_table "maryland_campaign_finance_contributions", force: :cascade do |t|
    t.date     "date"
  ...
  create_table "maryland_campaign_finance_contributors", force: :cascade do |t|

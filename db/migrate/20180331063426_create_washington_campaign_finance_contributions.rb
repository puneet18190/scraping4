class CreateWashingtonCampaignFinanceContributions < ActiveRecord::Migration
  def change
    create_table :washington_campaign_finance_contributions do |t|
    ...
    execute 'ALTER TABLE washington_campaign_finance_contributions MODIFY id bigint(20) DEFAULT NULL auto_increment NOT NULL'
  end
end
